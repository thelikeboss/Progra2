...
public class inv {
    public static void main(String[] args) {
        ...
        inventario.agregarProducto("Laptop HP", "Laptop 15 pulgadas, 8GB RAM", 899.99, 10, "Tecnología");
        inventario.agregarProducto("Mouse Inalámbrico", "Mouse óptico inalámbrico", 25.50, 50, "Tecnología");
        inventario.agregarProducto("Silla Oficina", "Silla ergonómica para oficina", 199.99, 3, "Muebles");
        inventario.agregarProducto("Monitor 24\"", "Monitor LED 24 pulgadas", 299.99, 0, "Tecnología");
