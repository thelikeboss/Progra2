...
public class Producto {
    ...
    public static void main(String[] args) {
        Producto producto1 = new Producto("P001", "Laptop", 1500.00);
        Producto producto2 = new Producto("P002", "Smartphone", 800.00);
        Producto producto3 = new Producto("p003","Ps5",5000.89);
        Producto producto4 = new Producto("p004","Tableta",1000.60);
        Producto producto5 = new Producto("p005","Reloj Digital",2500.99);
